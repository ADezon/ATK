      ...
      <div class="content">
        ...
        <div class="field-body">
          <p>Tens algun dubte, proposta o suggeriment que vulguis fer-nos arribar?
            No t’ho pensis dues vegades! Omple el següent formulari, amb la teva consulta, i et donarem resposta al més
            aviat possible.</p>
        </div>
      ...
      <div id="more-contacts" class="cont-wrapper">
        <div class="content">
          ...
          <div class="more-contacts-element">
            ...
            <span
                class="more-contacts-description">Truca’ns als 115, o al +376301115, si truques des de l’estranger</span>
          </div>
          <div class="more-contacts-element">
            <span class="more-contacts-icon"><span class="icons icon-hands"></span></span>
            <span class="more-contacts-title">Vine a veure’ns.</span>
            <span class="more-contacts-description">Vine a l’agència comercial. Localitza la nostra <a
                  href="">agència</a></span>
          </div>
