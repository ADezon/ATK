          ...
          <div class="services-full-info">
            <div class="config-client-products">
                ...
                <div class="products-inner-container">
                  ...
                  <div class="products-block-forfeit odd">
                    <div class="forfeit-info">
                      <div class="forfeit-name">Forfet</div>
...
<!--                /* Blocks */-->
                    ...
                    <div class="inner-box">
                      ...
                      <div class="custom-item three">
                        <div class="actions-container">
                          <a href="#"
                             class="button-pink action-activate">Contractar</a>
                          <a href="#"
                             class="button-active">+
                            Info</a>
                        </div>
  ...
  <div class="general-alert-wrapper fixedone">
    <div class="content-general-wrapper clientproducts"> <!---->
      ...
      <div class="alert-general-body"></div>
    </div>
  ...
  <script language="JavaScript">
      $(document).ready(function () {
          ...
          // action-ampliar-forfeit
          $('.action-ampliar-forfeit').click(function (e) {
              e.preventDefault();
              $.post("includes/fake_api.php", {operation: 'action_ampliar_forfeit'})
                  .done(function (data) {
          ...
          // action-dades-extra
          $('.action-dades-extra').click(function (e) {
              e.preventDefault();
              $.post("includes/fake_api.php", {operation: 'action_dades_extra'})
                  .done(function (data) {
                      alertTitle.html(data.title);
                      alertBody.html(data.body);
                  })
