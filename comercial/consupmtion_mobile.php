        ...
        <div class="content">
          ...
          <div id="tabs" class="tabs-first-level">
            <ul>
              ...
              <li><a href="#tabs-3"><h2 class="global-subtitle">SMS</h2></a></li>
            </ul>
            <div id="tabs-1">
              <div class="chart-call-consumption">
                <div class="tabs-second-level">
                  <ul>
                    <li><a href="#tabs-call-chart"><span class="icons icon-graphic-bar"></span>Gráfic</a></li>
...
/*
    ...
    <div class="general-alert-wrapper">
      <div class="content-general-wrapper clientproducts" id="popup">
        ...
        <div class="alert-general-title">Canviar forfet</div>
        <div class="alert-general-body">

          <div class="products-floating-box">
            <div class="config-box">
              <h3>Ampliar forfet</h3>
              <div class="info-forfet-message">Aquesta acció s’aplicarà de forma inmediata.</div>
              <div class="inner-box">
                <div class="custom-item one">
