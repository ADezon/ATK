...
<div id="header">
        ...
        <div class="content">
            <div class="left">
                <ul class="links-topbar">
                    <li>
                        <span class="icons icon-mobile"></span><a href="#" title="">Mobiland clic</a>
                    </li>
                    <li>
                        <span class="icons icon-phone"></span><a href="#" title="">Guia Telefònica</a>
                    </li>
                    <li>
                        <span class="icons icon-tv"></span> <a href="#" title="">Programació TV</a>
                    </li>
                    <li>
    ...
    <div id="head" class="cont-wrapper">
        <div class="content">
            ...
            <div class="right">
                ...
                <div class="button-login-client active-loged" href="#" title=""><span class="icons icon-client"></span><span>Hola, Alejandra</span></div>
            </div>
        </div>
    </div>
    <!-- END REGION HEAD -->
    ...
    <div class="container-client-area">
        <div class="box-client-area box-client-loged">
            ...
            <a href="" class="banner-client-loged"><img src="./uploaded_files/banner-wifi-loged.png" /></a>
            <div class="logout">
    ...
    <div id="nav-private" class="cont-wrapper">
        <div class="menu content content-big">
            <ul>
                <li class="active">
                    <div class="title-level-1"><span class="icons icon-mobile"></span><span>SOM Telefonia Mòbil</span>
                    </div>
                ...
                <li>
                    <div class="title-level-1"><span class="icons icon-phone"></span><span>SOM Internet i Fixa</span>
                    </div>
                    <div class="container-submenu">
                        <ul>
                            <li>
                ...
                <li>
                    <div class="title-level-1"><span class="icons icon-tv"></span><span>SOM Televisió</span></div>
                    <div class="container-submenu">
                        <ul>
                            <li>
                                <a href="#" title="">
            ...
            <div class="button-client-area active-loged">
