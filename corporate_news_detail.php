<?php include 'includes/header_corporate.php'; ?>

  <!-- BEGIN ALL SECTION 1 COLUMNS W/sidebar -->
    ...
    <div class="content">
      ...
      <div class="main-page-content news-detail">
        <div class="content-ws righted">
          ...
          <h1 class="news-title">Andorra Telecom incorpora 19 treballadors eventuals durant l’estiu</h1>
          ...
          <div class="content-inner-container">
            <div class="vertical-social">
              <ul>
                <li><a href="#" class="icons icon-goto"></a></li>
                <li><a href="#" class="icons icon-facebook"></a></li>
                <li><a href="#" class="icons icon-twitter"></a></li>
                <li><a href="#" class="icons icon-lkndn"></a></li>
                <li><a href="#" class="icons icon-email"></a></li>
              </ul>
            </div>
  ...
  <!-- END ALL SECTION 1 COLUMNS W/sidebar  -->


<?php include 'includes/footer_corporate.php'; ?>