             ...
             <fieldset class="aui-fieldset  ">
               ...
               <span class="aui-field aui-field-select aui-field-menu">
                  <span class="aui-field-content">
                     ...
                     <span class="aui-field-element ">
                        <div class="jqTransformSelectWrapper" style="z-index: 10; width: 149px;">
                           <div class="jqTransformSelectInsideWrapper"><span style="width: 120px;">
                              Qualsevol
                              </span>
                           </div>
               ...
               <span class="aui-field aui-field-select aui-field-menu">
                  <span class="aui-field-content">
                     ...
                     <div class="ui-widget">
                        <div class="jqTransformSelectWrapper" style="z-index: 9; width: 403px;">
                           <div class="jqTransformSelectInsideWrapper"><span style="width: 374px;">Qualsevol</span></div>
                           <a href="#" class="jqTransformSelectOpen"></a>
                           <ul style="height: 280px; display: none; visibility: visible;">
               ...
               <span class="aui-field aui-field-select aui-field-menu">
                  <span class="aui-field-content">
                     ...
                     <span class="aui-field-element ">
                        <div class="jqTransformSelectWrapper" style="z-index: 8; width: 149px;">
                           <div class="jqTransformSelectInsideWrapper"><span style="width: 120px;">
                              Qualsevol
                              </span>
                           </div>
               ...
               <span class="aui-field aui-field-select aui-field-menu">
                  <span class="aui-field-content">
                     ...
                     <span class="aui-field-element ">
                        <div class="jqTransformSelectWrapper" style="z-index: 7; width: 149px;">
                           <div class="jqTransformSelectInsideWrapper"><span style="width: 120px;">
                              Totes
                              </span>
                           </div>
